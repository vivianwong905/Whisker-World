...
import { Box, Card, Checkbox, Slider, Typography, FormGroup, FormControlLabel, FormControl, InputLabel, SwipeableDrawer, Button, } from '@mui/material';
...
const Filters = () => {
  ...
  return (
    <div>
          <Button variant="contained" sx={{ marginTop:1, "&:hover": { bgcolor: "magenta", color: "white" }}} onClick={() => setIsDrawerOpen(true)}>Filter</Button>
          <SwipeableDrawer
            anchor="right"
            open={isDrawerOpen}
